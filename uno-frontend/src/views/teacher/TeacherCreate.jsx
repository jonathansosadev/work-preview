...
import { teacherActions, matterActions, agencyActions } from '../../actions';
// core components
import AdminNavbar from "../../components/Navbars/AdminNavbar";
import SideBar from "../../components/SideBar/SideBar"
import { Col, Row, Button, Form, FormGroup, Label, Container, Alert, Table, Modal, FormText   } from 'reactstrap';
...
function TeacherCreatePage() {
    ...
    //State de guardado
    const registering = useSelector(state => state.teachers.registering);
    const registerSuccess = useSelector(state => state.teachers.register);
