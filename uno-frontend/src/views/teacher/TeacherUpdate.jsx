...
function TeacherUpdatePage() {
    ...
    useEffect(() => {
        if(teachers.searched){
            ...
            var newDate = moment(teacherState.birthday).utc().format("YYYY-MM-DD");
            setAgencySelected(teacherState.agency);
            setStatusSelected(teacherState.status);
            setDate(newDate);
        }
    },[teachers.searched]);
                                ...
                                <Form onSubmit={handleSubmit(onUpdateData)}className="form">
                                    ...
                                    <Row form>
                                        ...
                                        <FormGroup>
                                            ...
                                            <Datetime locale="Es-es" timeFormat={false} initialValue={teacher.birthday ? moment(teacher.birthday).utc().format('YYYY-MM-DD'):''}
                                                closeOnSelect
                                                isValidDate={ valid }
