...
//componente dataScoresStudent sede
...
function ScoreStudentPage() {
	...
	const getDataTable = (page) => {
		dispatch(scoreActions.dataScoresStudent(getUserData(), page, perPageSelect == 0 ? perPage : perPageSelect, direction, {}));
	}
	
	//Paginar
	const handlePageChange = async (page) => {
		dispatch(scoreActions.dataScoresStudent(getUserData(),page, perPageSelect == 0 ? perPage : perPageSelect, direction, filters ? filters: {}));
	};
	...
	const handleSort = (column, sortDirection) => {
		...
		setDirection(sort);
		dispatch(scoreActions.dataScoresStudent(getUserData(), 1, perPageSelect == 0 ? perPage : perPageSelect, sort, filters ? filters: {}));
	};

	//Cambiar cantidad de filas
	const handlePerRowsChange = async (newPerPage, page) => {
		setPerPageSelect(newPerPage);
		dispatch(scoreActions.dataScoresStudent(getUserData(),page, newPerPage, direction, filters ? filters: {}));
	};
	...
	const onFilterData = (data, e) => {
		setFilters(data);
		dispatch(scoreActions.dataScoresStudent(getUserData(), 1, perPageSelect == 0 ? perPage : perPageSelect, direction, data))
	}
					...
					<div className="flex-column flex-md-row p-3">
						<div className="d-flex justify-content-between" style={{padding:"4px 16px 4px 24px"}}>
							<div className="align-self-center">
								<h3 style={{ marginBottom: '0' }}>Mis calificaciones</h3>
							</div>
						</div>
						 {/* Filtros */}
