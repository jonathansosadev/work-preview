...
//componente dataScores sede
import '../../assets/css/table.css';
import { useForm  } from "react-hook-form";

function ScoreAdminPage() {
	...
	const dataStudents = useSelector(state => state.score.table);
	...
	const getDataTable = (page) => {
		dispatch(scoreActions.dataScores( page, perPageSelect == 0 ? perPage : perPageSelect, direction, {}));
	}
	
	//Paginar
	const handlePageChange = async (page) => {
		dispatch(scoreActions.dataScores( page, perPageSelect == 0 ? perPage : perPageSelect, direction, filters ? filters: {}));
	};
	...
	const handleSort = (column, sortDirection) => {
		...
		setDirection(sort);
		dispatch(scoreActions.dataScores( 1, perPageSelect == 0 ? perPage : perPageSelect, sort, filters ? filters: {}));
	};

	//Cambiar cantidad de filas
	const handlePerRowsChange = async (newPerPage, page) => {
		setPerPageSelect(newPerPage);
		dispatch(scoreActions.dataScores( page, newPerPage, direction, filters ? filters: {}));
	};
	...
	const clearFilters = () =>{
        reset();
        reset({document:'', fistName:'', lastName:'',  email:''})
	}
	...
	const onFilterData = (data, e) => {
		setFilters(data);
		dispatch(scoreActions.dataScores( 1, perPageSelect == 0 ? perPage : perPageSelect, direction, data))
	}
