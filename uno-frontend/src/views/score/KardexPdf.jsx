...
import logo from '../../assets/img/pdf/logo.jpg';
...
function KardexPdfPage() {
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.container}>
                        <View style={styles.detailColumn}>
                            <Text style={styles.titleKardex}>KÁRDEX DE CALIFICACIONES </Text>
                        </View>
                    </View>
    ...
    const DownloadPdf = () => {
        return useMemo(
          () => (
            <PDFDownloadLink  document={<Kardex />} className="btn btn-round btn-primary" style={{color:'white'}} fileName={`kardex.pdf`}>
                    ...
                    <div className="container-fluid">
                        ...
                        <Row > {/* style={{ height:'100vh' }} */}
                            <Col sm="12" md={{ size: 12, }}>
                                ...
                                {readyDoc && <>
                                    <div className="text-center" style={{fontSize:14, marginBottom:20, fontWeight:'bold'}}>KÁRDEX DE CALIFICACIONES</div>
