...
function FileListAdminPage() {
	...
	const getDataTable = (page) => {
		dispatch(fileActions.dataTableFiles(page, perPageSelect == 0 ? perPage : perPageSelect, direction, {}));
	}
	
	//Paginar
	const handlePageChange = async (page) => {
		dispatch(fileActions.dataTableFiles(page, perPageSelect == 0 ? perPage : perPageSelect, direction, filters ? filters: {}));
	};
	...
	const handleSort = (column, sortDirection) => {
		...
		setDirection(sort);
		dispatch(fileActions.dataTableFiles(1, perPageSelect == 0 ? perPage : perPageSelect, sort, filters ? filters: {}));
	};

	//Cambiar cantidad de filas
	const handlePerRowsChange = async (newPerPage, page) => {
		setPerPageSelect(newPerPage);
		dispatch(fileActions.dataTableFiles(page, newPerPage, direction, filters ? filters: {}));
	};
	...
	const onFilterData = (data, e) => {
		...
		setFilters(data);
        dispatch(fileActions.dataTableFiles(1, perPageSelect == 0 ? perPage : perPageSelect, direction, data));
	}
...
export default FileListAdminPage;