...
var urls = {
  ...
  ADMIN_DATA_FILE_IMPORTER_FROM_FILESTORE: {
    link: baseUrls.DARKBO + '/data-file/importer/import-from-filestore/:garageId/:filePath/:importSchemaName/:dataType',
  ...
  ADMIN_GARAGE_TEST_YUZER_GETCSV: baseUrls.DARKBO + '/garages/testnextyuzergetcsv',
  ...
  ADMIN_MONITORING_PROFILER: baseUrls.DARKBO + '/application/profiler',
...
const getUrlNamespace = name => {
  return urls[name] || {};
};

export { getShortUrl, getUrl, getSpecificUrl, getUrls, getUrlNamespace };
