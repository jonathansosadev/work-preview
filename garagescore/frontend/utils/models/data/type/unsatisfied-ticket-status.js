...
export default new Enum({
  ...
  displayName(value, language = 'fr') {
    ...
    switch (value) {
      case this.WAITING_FOR_CONTACT : return 'Client à contacter';
      case this.WAITING_FOR_VISIT : return 'Visite client à planifier';
      case this.WAITING_FOR_CLOSING : return 'A clôturer';
      case this.CONTACT_PLANNED : return 'Contact planifié';
      case this.VISIT_PLANNED : return 'Visite client planifiée';
      case this.CLOSED_WITHOUT_RESOLUTION : return 'Fermé, problème non résolu';
      case this.CLOSED_WITH_RESOLUTION : return 'Fermé, problème résolu';
