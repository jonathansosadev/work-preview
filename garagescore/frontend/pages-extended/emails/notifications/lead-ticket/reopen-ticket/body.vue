<template>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <BaseHeader
          :title="$t_locale('pages-extended/emails/notifications/lead-ticket/reopen-ticket/body')('title')"
      ...
      <tr>
        <td align="center" id="content">
          {{ $t_locale('pages-extended/emails/notifications/lead-ticket/reopen-ticket/body')('greetings') }}<br/><br/>
          <span class="bolded">
            {{ payload.assigner.getShortDescription() }}</span>, <JobHandler :job="payload.assigner.job"></JobHandler>, {{ $t_locale('pages-extended/emails/notifications/lead-ticket/reopen-ticket/body')('reopened') }}<br/><br/>
          <div class="bolded">{{ $t_locale('pages-extended/emails/notifications/lead-ticket/reopen-ticket/body')('details') }}</div><br/>
          <div class="left-margin">
            <span>
              {{$t_locale('pages-extended/emails/notifications/lead-ticket/reopen-ticket/body')('client')}}
    ...
    <tr>
      <CentralButton
        :text="$t_locale('pages-extended/emails/notifications/lead-ticket/reopen-ticket/body')('go')"
  ...
  computed: {
    ...
    closingReasons() {
      ...
      for (const reason of reasons) {
        ...
        stringList += this.$t_locale('pages-extended/emails/notifications/lead-ticket/reopen-ticket/body')(reason);
      }
      return stringList;
    }
  },
