...
<script>
  ...
  export default {
    computed: {
      ...
      title() {
        return this.$t_locale('pages-extended/emails/notifications/escalate/leads/2/subject')('title', {
          lead: this.$t_locale('pages-extended/emails/notifications/escalate/leads/2/subject')(`lead_${this.sourceTypeCategory}`, { sourceType: this.sourceType}),
          saleType: this.$t_locale('pages-extended/emails/notifications/escalate/leads/2/subject')(this.saleType),
          client: this.client,
