<template>
  <div class="country-flag">
    <!-- France -->
    <svg v-if="country === 'fr'" xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-fr" viewBox="0 0 640 480">
    ...
    <!-- Spain -->
    <svg v-if="country === 'es'"  xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-es" viewBox="0 0 640 480">
