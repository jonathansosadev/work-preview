...
const typePrefix = 'garageSetCreateSubscriptions';
  ...
  Mutation: {
    [typePrefix]: async (
      ...
      const actions = [
        ...
        BillingAccountPipelineCatalog.checkIfDateStartIsValid,
        BillingAccountPipelineCatalog.checkIfGarageAlreadyHasActiveSubscription,
        BillingAccountPipelineCatalog.createSubscription,
        BillingAccountPipelineCatalog.checkIfShouldBillNow,
        BillingAccountPipelineCatalog.notifySlackChannelsCreation,
      ];
