...
var debug = require('debug')(
  'garagescore:common:lib:garagescore:data-file:importer:customer-foreign-garageprovidedcustomerid'
); // eslint-disable-line max-len,no-unused-vars
// var gsLogger = require('../../logger');
var s = require('underscore.string');
var parseUtils = require('./parse-utils');

module.exports = function importCustomerForeignGarageProvidedCustomerId(
  dataRecord,
  rowIndex,
  rowCells,
  options,
  ...
  // -> dataRecord.customer.foreign.garageProvidedCustomerId
  ...
  if (!s.isBlank(cellValue)) {
    dataRecord.importStats.dataPresence.customer.foreign.garageProvidedCustomerId = true;
    ...
    dataRecord.customer.foreign.garageProvidedCustomerId = cellValue;
  } else {
    // gsLogger.warn('Row %d, Column "%s": Empty value', rowIndex, cellLabel);
    dataRecord.importStats.dataPresence.customer.foreign.garageProvidedCustomerId = false;
  }
