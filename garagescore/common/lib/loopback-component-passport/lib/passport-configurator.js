...
// const { enableUserCache } = require('./auth-user-cache');
...
PassportConfigurator.prototype.setupModels = function (options) {
  ...
  // this.userModel = enableUserCache(this.userModel); // #3067
        ...
        new AuthStrategy(
          ...
          function (req, user, done) {
            if (user) {
              ...
              self.userIdentityModel.login(name, authScheme, profile, {}, OptionsForCreation, loginCallback(req, done));
            } else {
              done(null);
            }
          }
