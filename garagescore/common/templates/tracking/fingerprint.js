  ...
  return (
    (e.prototype = {
        ...
        var t = this,
          r = {
            ...
            addPreprocessedComponent: function (e) {
              var n = e.value;
              'function' == typeof t.options.preprocessor && (n = t.options.preprocessor(e.key, n)),
      ...
      customEntropyFunction: function (e) {
        return (
          'function' == typeof this.options.customFunction &&
            e.addPreprocessedComponent({ key: 'custom', value: this.options.customFunction() }),
          e
        );
      },
      userAgentKey: function (e) {
        return (
          this.options.excludeUserAgent ||
            e.addPreprocessedComponent({ key: 'user_agent', value: this.getUserAgent() }),
          e
        );
      },
      ...
      colorDepthKey: function (e) {
        return (
          this.options.excludeColorDepth ||
            e.addPreprocessedComponent({ key: 'color_depth', value: window.screen.colorDepth || -1 }),
          e
        );
      },
      deviceMemoryKey: function (e) {
        return (
          this.options.excludeDeviceMemory ||
            e.addPreprocessedComponent({ key: 'device_memory', value: this.getDeviceMemory() }),
          e
        );
      },
      ...
      pixelRatioKey: function (e) {
        return (
          this.options.excludePixelRatio ||
            e.addPreprocessedComponent({ key: 'pixel_ratio', value: this.getPixelRatio() }),
          e
        );
      },
      ...
      getScreenResolution: function (e) {
        ...
        return (
          (t =
            this.options.detectScreenOrientation && window.screen.height > window.screen.width
        ...
        return (
          window.screen.availWidth &&
            ...
            (t = this.options.detectScreenOrientation
              ...
              : [window.screen.availHeight, window.screen.availWidth]),
          void 0 !== t && e.addPreprocessedComponent({ key: 'available_resolution', value: t }),
          e
        );
      },
      timezoneOffsetKey: function (e) {
        return (
          this.options.excludeTimezoneOffset ||
            e.addPreprocessedComponent({ key: 'timezone_offset', value: new Date().getTimezoneOffset() }),
          e
        );
      },
      ...
      cpuClassKey: function (e) {
        return (
          this.options.excludeCpuClass ||
            e.addPreprocessedComponent({ key: 'cpu_class', value: this.getNavigatorCpuClass() }),
          e
        );
      },
      platformKey: function (e) {
        return (
          this.options.excludePlatform ||
            e.addPreprocessedComponent({ key: 'navigator_platform', value: this.getNavigatorPlatform() }),
          e
        );
      },
      doNotTrackKey: function (e) {
        return (
          this.options.excludeDoNotTrack ||
            e.addPreprocessedComponent({ key: 'do_not_track', value: this.getDoNotTrack() }),
          e
        );
      },
      canvasKey: function (e) {
        return (
          !this.options.excludeCanvas &&
            ...
            e.addPreprocessedComponent({ key: 'canvas', value: this.getCanvasFp() }),
          e
        );
      },
      webglKey: function (e) {
        return (
          !this.options.excludeWebGL &&
            ...
            e.addPreprocessedComponent({ key: 'webgl', value: this.getWebglFp() }),
          e
        );
      },
      webglVendorAndRendererKey: function (e) {
        return (
          !this.options.excludeWebGLVendorAndRenderer &&
            this.isWebGlSupported() &&
            e.addPreprocessedComponent({ key: 'webgl_vendor', value: this.getWebglVendorAndRenderer() }),
          e
        );
      },
      adBlockKey: function (e) {
        return (
          this.options.excludeAdBlock || e.addPreprocessedComponent({ key: 'adblock', value: this.getAdBlock() }), e
        );
      },
      hasLiedLanguagesKey: function (e) {
        return (
          this.options.excludeHasLiedLanguages ||
            e.addPreprocessedComponent({ key: 'has_lied_languages', value: this.getHasLiedLanguages() }),
          e
        );
      },
      hasLiedResolutionKey: function (e) {
        return (
          this.options.excludeHasLiedResolution ||
            e.addPreprocessedComponent({ key: 'has_lied_resolution', value: this.getHasLiedResolution() }),
          e
        );
      },
      hasLiedOsKey: function (e) {
        return (
          this.options.excludeHasLiedOs ||
            e.addPreprocessedComponent({ key: 'has_lied_os', value: this.getHasLiedOs() }),
          e
        );
      },
      hasLiedBrowserKey: function (e) {
        return (
          this.options.excludeHasLiedBrowser ||
            e.addPreprocessedComponent({ key: 'has_lied_browser', value: this.getHasLiedBrowser() }),
          e
        );
      },
          ...
          this.options.excludePlugins ||
            (this.isIE()
              ? this.options.excludeIEPlugins ||
                e.addPreprocessedComponent({ key: 'ie_plugins', value: this.getIEPlugins() })
              : e.addPreprocessedComponent({ key: 'regular_plugins', value: this.getRegularPlugins() })),
          e
        );
      },
      ...
      touchSupportKey: function (e) {
        return (
          this.options.excludeTouchSupport ||
            e.addPreprocessedComponent({ key: 'touch_support', value: this.getTouchSupport() }),
          e
        );
      },
      hardwareConcurrencyKey: function (e) {
        return (
          this.options.excludeHardwareConcurrency ||
            e.addPreprocessedComponent({ key: 'hardware_concurrency', value: this.getHardwareConcurrency() }),
          e
        );
      },
      ...
      getWebglFp: function () {
        ...
        e.shaderSource(
          ...
          e.vertexAttribPointer(a.vertexPosAttrib, n.itemSize, e.FLOAT, !1, 0, 0),
        ...
        try {
          ...
          l &&
            (r.push('webgl unmasked vendor:' + e.getParameter(l.UNMASKED_VENDOR_WEBGL)),
            r.push('webgl unmasked renderer:' + e.getParameter(l.UNMASKED_RENDERER_WEBGL)));
        } catch (e) {}
      ...
      getHasLiedOs: function () {
        ...
        return (
          ...
          ((n.indexOf('linux') >= 0 || n.indexOf('android') >= 0 || n.indexOf('pike') >= 0) &&
            'Linux' !== e &&
            'Android' !== e) ||
          ((n.indexOf('mac') >= 0 || n.indexOf('ipad') >= 0 || n.indexOf('ipod') >= 0 || n.indexOf('iphone') >= 0) &&
            'Mac' !== e &&
            'iOS' !== e) ||
          (-1 === n.indexOf('win') && -1 === n.indexOf('linux') && -1 === n.indexOf('mac')) != ('Other' === e) ||
      ...
      x64hash128: function (e, t) {
        ...
        switch (((o = [0, 0]), (s = [0, 0]), r)) {
          ...
          case 1:
            (o = this.x64Xor(o, [0, e.charCodeAt(h)])),
              (o = this.x64Multiply(o, l)),
              (o = this.x64Rotl(o, 31)),
              (o = this.x64Multiply(o, d)),
              (i = this.x64Xor(i, o));
...
var setCookie = function (e, r, t, o, a, i) {
  if (!e || /^(?:expires|max\-age|path|domain|secure)$/i.test(e)) return !1;
  var n = '';
  if (t)
    switch (t.constructor) {
      case Number:
        n = t === 1 / 0 ? '; expires=Fri, 31 Dec 9999 23:59:59 GMT' : '; max-age=' + t;
        break;
      case String:
        n = '; expires=' + t;
        break;
...
setTimeout(function () {
  var options = { excludeUserAgent: true, excludeAdBlock: true };
  new Fingerprint2(options).get(function (hash) {
    setCookie('fingerprint', hash);
  });
}, 50); // delay the fingerprinting to be more consistent
