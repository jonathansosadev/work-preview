...
module.exports = new Enum(
  ...
  },
  {
    displayName(value, language = 'fr') {
      ...
      switch (value) {
        case this.MAINTENANCE_LAB_1:
          return 'Accueil et prise en charge';
        case this.MAINTENANCE_LAB_2:
          return 'Écoute et conseils';
        case this.MAINTENANCE_LAB_3:
          return 'Clarté et détail du devis';
        case this.MAINTENANCE_LAB_4:
          return 'Respect des engagements de délai et de tarif';
        case this.MAINTENANCE_LAB_5:
          return 'Qualité générale de la prestation';
        case this.SALE_NEW_LAB_1:
          return "Qualité générale de l'établissement";
        case this.SALE_NEW_LAB_2:
          return 'Professionnalisme des équipes';
        case this.SALE_NEW_LAB_3:
          return 'Services proposés (reprise, garantie, financement)';
        case this.SALE_NEW_LAB_4:
          return 'Livraison de mon véhicule';
        case this.SALE_NEW_LAB_5:
          return 'Satisfaction de mon véhicule';
        case this.SALE_USED_LAB_1:
          return 'Professionnalisme des équipes';
        case this.SALE_USED_LAB_2:
          return 'Historique de mon véhicule';
        case this.SALE_USED_LAB_3:
          return 'Services proposés (reprise, garantie, financement)';
        case this.SALE_USED_LAB_4:
          return 'Livraison de mon véhicule';
        case this.SALE_USED_LAB_5:
          return 'Satisfaction de mon véhicule';
        default:
          return value;
      }
