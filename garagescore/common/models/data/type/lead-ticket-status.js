    ...
    displayName(value, language = 'fr') {
      ...
      switch (value) {
        case this.WAITING_FOR_CONTACT:
          return 'Contact à prendre';
        case this.WAITING_FOR_MEETING:
          return 'Rendez-vous à réaliser';
        case this.WAITING_FOR_PROPOSITION:
          return 'Proposition à envoyer';
        case this.WAITING_FOR_CLOSING:
          return 'A clôturer';
        case this.CONTACT_PLANNED:
          return 'Contact planifié';
        case this.MEETING_PLANNED:
          return 'Rendez-vous planifié';
        case this.PROPOSITION_PLANNED:
          return 'Proposition planifiée';
        case this.CLOSED_WITHOUT_SALE:
          return 'Fermé, vente non réalisée';
        case this.CLOSED_WITH_SALE:
          return 'Fermé, vente réalisée';
        default:
          return value;
      }
    },
