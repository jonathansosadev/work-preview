...
import HousingBookingPaymentsSection, {
...
function AddPaymentsSection() {
  ...
  const isSelfCheckinDisabled = false
  ...
  const arePaymentSectionsDisabled = isLoading || isLoadingPaymentSettings;
  ...
  return (
    <>
      {console.log(isBookingPaymentsSectionActive)}
      <ErrorModal />
      <ContentWrapper>
