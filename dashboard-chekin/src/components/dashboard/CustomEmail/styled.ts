...
import {BlueSmallLink, ACCOUNT_MAIN_WIDTH} from 'styled/common';
...
export const CustomEmailHeader = styled(FormHeader)`
...
export const EmailDetailsSection = styled(SectionWithoutExplicitStyles)`
  margin-top: 16px;
`;
...
export const EmailDetailsInput = styled(InputController)`
  width: 100%;
`;
...
export const EmailDetailsTextarea = styled(TextareaController)`
  margin-bottom: -2px;
...
export const VariablesItem = styled(BlueSmallLink)`
  font-family: ProximaNova-Semibold, sans-serif;
  font-size: 16px;
  margin-bottom: 10px;
  color: ${BASE_BLUE_COLOR};
