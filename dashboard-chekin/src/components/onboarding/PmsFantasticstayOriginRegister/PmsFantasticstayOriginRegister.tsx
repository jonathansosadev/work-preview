...
import fantasticstayLogoIcon from '../../../assets/fantasticstay-logo.png';
...
function PmsFantasticstayOriginRegister() {
  ...
  const registerFantasticstayUser = async (payload = {}) => {
    payload = getRegisterPayload(payload);
    const {data, error} = await api.auth.integrationRegister('fantasticstay', payload);
    if (data) {
      mixpanelTrackWithUTM('Onboarding - Fantasticstay');
  ...
  const onSubmit = async (data = {}) => {
    setIsLoading(true);
    await registerFantasticstayUser(data);
    setIsLoading(false);
  };
    ...
    <>
      ...
      <Wrapper>
        <DimensionsWrapper>
          ...
          <Content>
            <SyncTile>
              <Logo src={fantasticstayLogoIcon} alt="Fantasticstay" />
                ...
                <ButtonAndLoaderWrapper>
                  {isLoading ? (
                    ...
                    <Button
                      ...
                      light
                      size="big"
                      label={t('connect_with_fantasticstay')}
