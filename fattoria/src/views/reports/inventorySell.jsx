...
function InventorySellPage() {
	...
	const onFilterData = (data, e) => {
		...
		setFilters(data);
		dispatch(inventoryActions.dataTableSell(getUserData(), 1, perPageSelect == 0 ? perPage : perPageSelect, direction, data, false));
	}
					...
					<div className="flex-column flex-md-row p-3">
						<div className="d-flex justify-content-between" style={{padding:"4px 16px 4px 24px", marginBottom:10}}>
							<div className="align-self-center">
								<h3 style={{ fontWeight:'bold',fontStyle: 'italic',  marginBottom: '0'}}>Reporte de ventas</h3>
							</div>
						</div>
						{/* Filtros */}
